...
/**
 * Created by Magally on 14-09-2015.
 */
public class GetMyAnswerTask extends AsyncTask<Void,Void,Void> {

    public AsyncResponse delegate = null;


    private static String url_create_user = "http://192.168.1.113/michigan_server/get_my_answers.php";
    private static String LOG_TAG = "GetMyAnswerTask";
    ...
    public GetMyAnswerTask(Activity activity, AsyncResponse asyncResponse, String username) {
            ...
            if (success == 1) {
                ...
                for(int i = 0; i<preguntaArray.length; i++){
                    ...
                    preguntaArray[i]= new Pregunta(preguntaID,
                            ...
                            username,
                            reputacion);
                    Log.d("GetPregTask", "Questions received: "+ i);
                }
