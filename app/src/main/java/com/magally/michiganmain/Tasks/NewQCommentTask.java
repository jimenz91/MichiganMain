 ...
 */
public class NewQCommentTask extends AsyncTask <Void,Void,Void> {
    private static String url_create_user = "http://192.168.1.113/michigan_server/new_question_comment.php";
    private static String LOG_TAG = "NewQCommentTask";
    ...
    public NewQCommentTask(Activity activity, String comentario, long preguntaId, long usuarioId, String username) {
    ...
    protected Void doInBackground(Void... args) {
        ...
        if(json!=null)
            ...
            Log.d("NewQCommentActivity: ","Json empty");
            return null;
        }
